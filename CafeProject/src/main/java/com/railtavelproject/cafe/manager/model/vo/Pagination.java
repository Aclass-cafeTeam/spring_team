...
public class Pagination {
   ...
   private int currentPage;      // 현재 페이지 번호 --CP로 들고 옴
   private int listCount;         // 전체 게시글 수  --DB에서 조회
   
   private int limit = 15;         // 한 페이지 목록에 보여지는 게시글 수 --임의로 정하는 거
   private int pageSize = 5;      // 보여질 페이지 번호 개수 --임의로 정하는 거

  ...
  <main>    
              ...
              <table border="1" cellspacing="0" class="tbl_lst_type2">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <div class="inner">
                        <input type="text" id="staffType" class="_change(ManageCafeStaff|StaffType)" value="1" readonly style="width: 143px; height: 21px">부 매니저</input>
                  ...
                  <tr id="assignBoardStaffLayer" style="display: none;">
                    <th><strong>게시판 지정</strong></th>
                    <td>
                      <div class="inner">
                        <a class="btn_type _click(ManageCafeStaff|AssignBoardStaff) _stopDefault" href="#"><span>담당 게시판 지정</span></a>
                        <div id="assignBoardList" style="display:none" class="group_noti"></div>
                        <ul style="margin-top:9px" class="bu_lst_type2">
                          <li>담당 게시판 지정 버튼을 눌러 스탭을 추가할 게시판을 지정해주세요.<br>지정한 게시판에 대한 스탭은 아래에서 검색 후 추가하실 수 있습니다.</li>
                        </ul>
                      </div>
                    </td>
                  </tr>
                    ...
                    <td>
                      <div class="group_input_frm">
                        <div class="srch_in">
                          ...
                          <input type="text" id="mem_srch" class="text _keydown(ManageCafeStaff|SearchMember)" style="width: 248px; padding-left: 7px"> <a class="btn_type _click(ManageCafeStaff|SearchMember) _stopDefault" href="#"><span>검색</span></a>
                        </div>
          ...
          <div class="info">
            <input type="radio" id="electedStaffId_shuxi91" name="electedStaffId" class="check _click(ManageCafeStaff|MemberInfo)" value="shuxi91">
                  ...
                  <label for="r1" class="item _name _click(ManageCafeStaff|MemberInfo) _stopDefault">김서희(shuxi91)</label>
                   <span class="go_cgm">
                     <a href="#" class="_click(ManageCafeStaff|CafeActivity|shuxi91) _stopDefault">카페 활동정보</a>
      ...
      <ul id="save_txt" class="bu_lst_type2" style="display: block;">
        <li>선택한 멤버를 스탭으로 선정하시려면 '저장'을 눌러주세요.</li>
            ...
            <div class="ly_type" id="NamelessLayer" style="display:none;top:45px;left:270px">
              <div class="ly_cont" style="width:338px">
                <p><strong><span class="c_og" id="namelessMember">&nbsp;</span>님은<br>실명 확인을 하지 않으셨습니다.</strong></p>
                <p class="g_gy2" style="margin-top:8px;letter-spacing:0">부 매니저는 실명 확인된 멤버만 선정할 수 있습니다.<br>다른 멤버를 선정해주세요.</p>
                <div class="btn">
                  <a href="#" class="btn_type3 _click(LayerManager|CloseLayer|NamelessLayer) _stopDefault"><span>닫기</span></a>
                </div>
              </div>
              <a href="#" class="clse _click(LayerManager|CloseLayer|NamelessLayer) _stopDefault"><span class="blind">닫기</span></a>
            </div>
          </div>
              ...
              <table border="1" cellspacing="0" class="tbl_lst_type">
                ...
                <thead>
                  <tr>
                    ...
                    <th scope="col"><strong class="line_r">스탭선정일</strong></th>
                    <th scope="col"><strong class="line_r">최근관리내용</strong></th>
                    <th scope="col"><strong class="line_r">전체메시지 권한</strong></th>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="thmb"><img src="https://ssl.pstatic.net/static/cafe/cafe_profile3_45x45.gif" width="20" height="20" alt="" onerror="this.onerror=null;this.src='https://ssl.pstatic.net/static/cafe/cafe_profile3_45x45.gif'"></span><a href="#" class="nick _click(NicknameUI|OpenUI|rkdalsrb65) _stopDefault">상남자(rkdalsrb65)</a>
                    </td>
                    ...
                    <td class="active tc">
                                ...
                                <span class="permit  _messageAuth">
                                  <a href="#" class="_click(ManageCafeStaff|ModifyMessageAuth|rkdalsrb65) _allow _stopDefault on">허용</a><a href="#" class="_click(ManageCafeStaff|ModifyMessageAuth|rkdalsrb65) _disallow _stopDefault">비허용</a>
                                </span>
                                
                                
                              
                    </td><td class="tc"><a href="#" class="btn_type _click(ManageCafeStaff|ShowDeleteLayer|rkdalsrb65|2) _stopDefault"><span>삭제</span></a></td>
                  </tr>

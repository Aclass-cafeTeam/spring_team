CREATE TABLE "MEMBER" (
   ...
   "AUTHORITY_NO"   NUMBER   DEFAULT 2   NOT NULL
...
COMMENT ON COLUMN "MEMBER"."AUTHORITY_NO" IS '권한명(2: 일반회원, 0: 카페매니저 ,1 :부매니저)';
...
CREATE TABLE "CAFE_INFO" (
   ...
   "CAFE_JOIN_FL" CHAR(1) DEFAULT'Y' NOT NULL
);
...
COMMENT ON COLUMN "CAFE_INFO"."CAFE_JOIN_FL" IS '카페 가입 허가 여부';
...
CREATE TABLE "MEMBER_LEVEL" (
   ...
   "MEMBER_LEVEL_IMG" VARCHAR2(300) NULL
);
...
COMMENT ON COLUMN "MEMBER_LEVEL"."MEMBER_LEVEL_IMG" IS '멤버 등급 이미지';
...
CREATE TABLE "TITLE_TAG" (
   ...
   "TITLE_TAG_NAME"   VARCHAR2(50)      NOT NULL
);

COMMENT ON COLUMN "TITLE_TAG"."TITLE_TAG_NO" IS '말머리번호';

COMMENT ON COLUMN "TITLE_TAG"."TITLE_TAG_NAME" IS '말머리이름,내용';
...
CREATE TABLE "MEMBER_SECESSION" (
   ...
   "SECESSION_REASON_INFO" VARCHAR2(150) DEFAULT NULL
);
...
COMMENT ON COLUMN "MEMBER_SECESSION"."SECESSION_REASON_INFO" IS '탈퇴 사유(사유 내용 글)';
...
CREATE TABLE "MEMBER_HOLD" (
   ...
   "HOLD_REASON" VARCHAR2(150) DEFAULT NULL
);
...
COMMENT ON COLUMN "MEMBER_HOLD"."HOLD_REASON" IS '활동정지이유';
...
COMMENT ON COLUMN "AUTHORITY"."AUTHORITY_NAME" IS '권한명(일반회원, 카페매니저 ,부매니저)';
...
UPDATE "BOARD_TYPE" SET BOARD_FORM = 'A'
WHERE BOARD_CODE =13;
